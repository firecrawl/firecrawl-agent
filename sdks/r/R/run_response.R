...
#' @field exportedSkill  \link{ExportedSkill} [optional]
...
RunResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @param steps steps
    #' @param usage usage
    #' @param exportedSkill exportedSkill
    #' @param ... Other optional arguments.
    initialize = function(`text` = NULL, `data` = NULL, `format` = NULL, `steps` = NULL, `usage` = NULL, `exportedSkill` = NULL, ...) {
      if (!is.null(`text`)) {
      ...
      if (!is.null(`exportedSkill`)) {
        stopifnot(R6::is.R6(`exportedSkill`))
        self$`exportedSkill` <- `exportedSkill`
      }
    },
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`exportedSkill`)) {
        RunResponseObject[["exportedSkill"]] <-
          self$extractSimpleType(self$`exportedSkill`)
      }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`exportedSkill`)) {
        `exportedskill_object` <- ExportedSkill$new()
        `exportedskill_object`$fromJSON(jsonlite::toJSON(this_object$`exportedSkill`, auto_unbox = TRUE, digits = NA))
        self$`exportedSkill` <- `exportedskill_object`
      }
      self
    },
    ...
    fromJSONString = function(input_json) {
      ...
      self$`exportedSkill` <- ExportedSkill$new()$fromJSON(jsonlite::toJSON(this_object$`exportedSkill`, auto_unbox = TRUE, digits = NA))
      self
    },
