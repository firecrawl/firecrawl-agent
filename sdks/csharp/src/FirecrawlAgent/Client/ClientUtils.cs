...
[assembly: InternalsVisibleTo("FirecrawlAgent.Test")]
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is ModelConfig.ProviderEnum modelConfigProviderEnum)
                return ModelConfig.ProviderEnumToJsonValue(modelConfigProviderEnum);
            if (obj is RunRequest.FormatEnum runRequestFormatEnum)
                return RunRequest.FormatEnumToJsonValue(runRequestFormatEnum);
            if (obj is RunResponse.FormatEnum runResponseFormatEnum)
                return RunResponse.FormatEnumToJsonValue(runResponseFormatEnum);
            if (obj is SubAgentConfig.ToolsEnum subAgentConfigToolsEnum)
                return SubAgentConfig.ToolsEnumToJsonValue(subAgentConfigToolsEnum);
            if (obj is WorkerProgress.StatusEnum workerProgressStatusEnum)
                return WorkerProgress.StatusEnumToJsonValue(workerProgressStatusEnum);
