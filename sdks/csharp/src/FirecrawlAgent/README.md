...
inputSpec: agent-core/openapi.yaml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{056A8B6A-66B1-4526-A56C-B9957312D791}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IGetWorkerProgressApiResponse apiResponse = await api.GetWorkerProgressAsync("todo");
            Dictionary<string, WorkerProgress>? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Firecrawl Agent API
- appVersion: 0.1.0
- appDescription: AI-powered web research agent built on Firecrawl. Search, scrape, and extract structured data from the web. 
