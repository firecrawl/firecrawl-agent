...
$RunRequest = Initialize-RunRequest -Prompt "Get pricing for Vercel, Netlify, and Cloudflare Pages" -Stream $false -Format "json" -Schema  -Columns "MyColumns" -Urls "MyUrls" -Model $ModelConfig -SubAgentModel $ModelConfig -MaxSteps 0 -Skills "MySkills" # RunRequest | 
