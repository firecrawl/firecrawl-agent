...
function ConvertFrom-JsonToRunRequest {
    ...
    Process {
        ...
        $AllProperties = ("prompt", "stream", "format", "schema", "columns", "urls", "model", "subAgentModel", "maxSteps", "skills", "skillInstructions", "subAgents", "exportSkill")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "skillInstructions"))) { #optional property not found
            $SkillInstructions = $null
        } else {
            $SkillInstructions = $JsonParameters.PSobject.Properties["skillInstructions"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "subAgents"))) { #optional property not found
            $SubAgents = $null
        } else {
            $SubAgents = $JsonParameters.PSobject.Properties["subAgents"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "exportSkill"))) { #optional property not found
            $ExportSkill = $null
        } else {
            $ExportSkill = $JsonParameters.PSobject.Properties["exportSkill"].value
        }
