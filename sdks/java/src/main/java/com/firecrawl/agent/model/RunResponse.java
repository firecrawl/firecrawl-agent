...
import com.firecrawl.agent.model.ExportedSkill;
...
public class RunResponse {
  ...
  public static final String SERIALIZED_NAME_EXPORTED_SKILL = "exportedSkill";
  @SerializedName(SERIALIZED_NAME_EXPORTED_SKILL)
  @javax.annotation.Nullable
  private ExportedSkill exportedSkill;
  ...
  public RunResponse exportedSkill(@javax.annotation.Nullable ExportedSkill exportedSkill) {
    this.exportedSkill = exportedSkill;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ExportedSkill getExportedSkill() {
    return exportedSkill;
  }

  public void setExportedSkill(@javax.annotation.Nullable ExportedSkill exportedSkill) {
    this.exportedSkill = exportedSkill;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.text, runResponse.text) &&
        ...
        Objects.equals(this.exportedSkill, runResponse.exportedSkill);
  }

  @Override
  public int hashCode() {
    return Objects.hash(text, data, format, steps, usage, exportedSkill);
  }
  ...
  public String toString() {
    ...
    sb.append("    exportedSkill: ").append(toIndentedString(exportedSkill)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("text", "data", "format", "steps", "usage", "exportedSkill"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `exportedSkill`
      if (jsonObj.get("exportedSkill") != null && !jsonObj.get("exportedSkill").isJsonNull()) {
        ExportedSkill.validateJsonElement(jsonObj.get("exportedSkill"));
      }
  }
