...
import com.firecrawl.agent.auth.Authentication;
import com.firecrawl.agent.auth.HttpBasicAuth;
import com.firecrawl.agent.auth.HttpBearerAuth;
import com.firecrawl.agent.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "http://localhost:3000/api/v1";
    ...
    new ServerConfiguration(
      "https://your-deployment.vercel.app/api/v1",
      "Production",
      new HashMap<String, ServerVariable>()
    )
  ));
     ...
     * @return a {@link com.firecrawl.agent.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.firecrawl.agent.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.firecrawl.agent.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.firecrawl.agent.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.firecrawl.agent.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.firecrawl.agent.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.firecrawl.agent.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.firecrawl.agent.ApiException If fails to update the parameters
     */
     ...
     * @throws com.firecrawl.agent.ApiException If fail to serialize the request body object into a string
     */
