...
# Unit tests for FirecrawlAgent::ErrorResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FirecrawlAgent::ErrorResponse do
  #let(:instance) { FirecrawlAgent::ErrorResponse.new }

  describe 'test an instance of ErrorResponse' do
    it 'should create an instance of ErrorResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FirecrawlAgent::ErrorResponse)
    end
  end
