...
class RunResponse {
  ...
  bool operator ==(Object other) => identical(this, other) || other is RunResponse &&
    ...
    other.usage == usage &&
    other.exportedSkill == exportedSkill;
  ...
  int get hashCode =>
    ...
    (exportedSkill == null ? 0 : exportedSkill!.hashCode);

  @override
  String toString() => 'RunResponse[text=$text, data=$data, format=$format, steps=$steps, usage=$usage, exportedSkill=$exportedSkill]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.exportedSkill != null) {
      json[r'exportedSkill'] = this.exportedSkill;
    } else {
      json[r'exportedSkill'] = null;
    }
    return json;
  }
  ...
  static RunResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return RunResponse(
        ...
        exportedSkill: ExportedSkill.fromJson(json[r'exportedSkill']),
      );
    }
    return null;
  }
