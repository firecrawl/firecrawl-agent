...
class ModelConfig(BaseModel):
    ...
    model: Optional[StrictStr] = Field(default=None, description="Model identifier (e.g. \"gemini-3-flash-preview\", \"claude-sonnet-4-6\").")
    ...
    def provider_validate_enum(cls, value):
        ...
        if value not in set(['anthropic', 'openai', 'google', 'gateway', 'firecrawl', 'acp']):
            raise ValueError("must be one of enum values ('anthropic', 'openai', 'google', 'gateway', 'firecrawl', 'acp')")
        return value
