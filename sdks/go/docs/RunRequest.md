...
**SkillInstructions** | Pointer to **map[string]string** | Per-skill custom instructions. Keys are skill names, values are instruction strings appended when the skill is loaded.  | [optional] 
**SubAgents** | Pointer to [**[]SubAgentConfig**](SubAgentConfig.md) | Sub-agents available during this run. Each sub-agent becomes a tool the orchestrator can delegate tasks to.  | [optional] 
**ExportSkill** | Pointer to **bool** | When true, post-processes the run into a reusable skill package (SKILL.md + workflow.mjs + schema.json) returned in the response.  | [optional] [default to false]
...
`func (o *RunRequest) GetSkillInstructions() map[string]string`

GetSkillInstructions returns the SkillInstructions field if non-nil, zero value otherwise.

### GetSkillInstructionsOk

`func (o *RunRequest) GetSkillInstructionsOk() (*map[string]string, bool)`

GetSkillInstructionsOk returns a tuple with the SkillInstructions field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetSkillInstructions

`func (o *RunRequest) SetSkillInstructions(v map[string]string)`

SetSkillInstructions sets SkillInstructions field to given value.

### HasSkillInstructions

`func (o *RunRequest) HasSkillInstructions() bool`

HasSkillInstructions returns a boolean if a field has been set.

### GetSubAgents

`func (o *RunRequest) GetSubAgents() []SubAgentConfig`

GetSubAgents returns the SubAgents field if non-nil, zero value otherwise.

### GetSubAgentsOk

`func (o *RunRequest) GetSubAgentsOk() (*[]SubAgentConfig, bool)`

GetSubAgentsOk returns a tuple with the SubAgents field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetSubAgents

`func (o *RunRequest) SetSubAgents(v []SubAgentConfig)`

SetSubAgents sets SubAgents field to given value.

### HasSubAgents

`func (o *RunRequest) HasSubAgents() bool`

HasSubAgents returns a boolean if a field has been set.

### GetExportSkill

`func (o *RunRequest) GetExportSkill() bool`

GetExportSkill returns the ExportSkill field if non-nil, zero value otherwise.

### GetExportSkillOk

`func (o *RunRequest) GetExportSkillOk() (*bool, bool)`

GetExportSkillOk returns a tuple with the ExportSkill field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetExportSkill

`func (o *RunRequest) SetExportSkill(v bool)`

SetExportSkill sets ExportSkill field to given value.

### HasExportSkill

`func (o *RunRequest) HasExportSkill() bool`

HasExportSkill returns a boolean if a field has been set.
