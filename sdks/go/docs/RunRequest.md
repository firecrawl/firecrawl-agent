...
**Schema** | Pointer to **map[string]interface{}** | JSON Schema for structured output (used with format&#x3D;json). | [optional] 
**Columns** | Pointer to **[]string** | Column names for CSV output. | [optional] 
