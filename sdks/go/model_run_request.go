...
type RunRequest struct {
	...
	SkillInstructions map[string]string `json:"skillInstructions,omitempty"`
	...
	ExportSkill *bool `json:"exportSkill,omitempty"`
}
...
// GetSkillInstructions returns the SkillInstructions field value if set, zero value otherwise.
func (o *RunRequest) GetSkillInstructions() map[string]string {
	if o == nil || IsNil(o.SkillInstructions) {
		var ret map[string]string
		return ret
	}
	return o.SkillInstructions
}

// GetSkillInstructionsOk returns a tuple with the SkillInstructions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RunRequest) GetSkillInstructionsOk() (map[string]string, bool) {
	if o == nil || IsNil(o.SkillInstructions) {
		return map[string]string{}, false
	}
	return o.SkillInstructions, true
}
...
// SetSkillInstructions gets a reference to the given map[string]string and assigns it to the SkillInstructions field.
func (o *RunRequest) SetSkillInstructions(v map[string]string) {
	o.SkillInstructions = v
}
...
// SetSubAgents gets a reference to the given []SubAgentConfig and assigns it to the SubAgents field.
func (o *RunRequest) SetSubAgents(v []SubAgentConfig) {
	o.SubAgents = v
}

// GetExportSkill returns the ExportSkill field value if set, zero value otherwise.
func (o *RunRequest) GetExportSkill() bool {
	if o == nil || IsNil(o.ExportSkill) {
		var ret bool
		return ret
	}
	return *o.ExportSkill
}

// GetExportSkillOk returns a tuple with the ExportSkill field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RunRequest) GetExportSkillOk() (*bool, bool) {
	if o == nil || IsNil(o.ExportSkill) {
		return nil, false
	}
	return o.ExportSkill, true
}
...
// SetExportSkill gets a reference to the given bool and assigns it to the ExportSkill field.
...
func (o RunRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SkillInstructions) {
		toSerialize["skillInstructions"] = o.SkillInstructions
	}
	if !IsNil(o.SubAgents) {
		toSerialize["subAgents"] = o.SubAgents
	}
	if !IsNil(o.ExportSkill) {
		toSerialize["exportSkill"] = o.ExportSkill
	}
