...
public:
    ...
    /// </summary>
    std::map<utility::string_t, utility::string_t> getSkillInstructions() const;
    bool skillInstructionsIsSet() const;
    void unsetSkillInstructions();
    void setSkillInstructions(const std::map<utility::string_t, utility::string_t>& value);

    /// <summary>
    /// Sub-agents available during this run. Each sub-agent becomes a tool the orchestrator can delegate tasks to. 
    /// </summary>
    std::vector<std::shared_ptr<SubAgentConfig>> getSubAgents() const;
    bool subAgentsIsSet() const;
    void unsetSubAgents();
    void setSubAgents(const std::vector<std::shared_ptr<SubAgentConfig>>& value);
    ...
    /// </summary>
    bool isExportSkill() const;
    bool exportSkillIsSet() const;
    void unsetExportSkill();
    void setExportSkill(bool value);
...
protected:
    ...
    std::map<utility::string_t, utility::string_t> m_SkillInstructions;
    bool m_SkillInstructionsIsSet;

    std::vector<std::shared_ptr<SubAgentConfig>> m_SubAgents;
    bool m_SubAgentsIsSet;

    bool m_ExportSkill;
    bool m_ExportSkillIsSet;
