...
class RunRequest {
  ...
  @override
  String toString() => 'RunRequest[prompt=$prompt, stream=$stream, format=$format, schema=$schema, columns=$columns, urls=$urls, model=$model, subAgentModel=$subAgentModel, maxSteps=$maxSteps, skills=$skills]';
