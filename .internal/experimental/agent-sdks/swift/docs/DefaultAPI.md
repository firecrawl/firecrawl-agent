...
let runRequest = RunRequest(prompt: "prompt_example", stream: false, format: "format_example", schema: 123, columns: ["columns_example"], urls: ["urls_example"], model: ModelConfig(provider: "provider_example", model: "model_example"), subAgentModel: nil, maxSteps: 123, skills: ["skills_example"]) // RunRequest | 
