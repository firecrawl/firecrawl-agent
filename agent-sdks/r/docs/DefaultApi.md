...
var_run_request <- RunRequest$new("prompt_example", "stream_example", "json", 123, c("columns_example"), c("urls_example"), ModelConfig$new("anthropic", "model_example"), ModelConfig$new("anthropic", "model_example"), 123, c("skills_example")) # RunRequest | 
