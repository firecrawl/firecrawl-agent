...
from firecrawl_agent.api_client import ApiClient, RequestSerialized
from firecrawl_agent.api_response import ApiResponse
from firecrawl_agent.rest import RESTResponseType
...
class DefaultApi:
    ...
    def get_worker_progress(
        ...
        _param = self._get_worker_progress_serialize(
    ...
    @validate_call
    def get_worker_progress_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Dict[str, WorkerProgress]]:
        """Get parallel worker progress
    ...
    @validate_call
    def get_worker_progress_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_worker_progress_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/workers/progress',
