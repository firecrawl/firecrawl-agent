...
open class FirecrawlAgentAPIConfiguration: @unchecked Sendable {
    ...
    public static let shared = FirecrawlAgentAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: FirecrawlAgentAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: FirecrawlAgentAPIConfiguration = FirecrawlAgentAPIConfiguration.shared) {
        self.method = method
